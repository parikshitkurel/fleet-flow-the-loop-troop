...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && ($_POST['_action'] ?? '') === 'create') {
    ...
    if (empty($errors)) {
        ...
        redirect('/fleetflow/modules/trips.php', "Trip {$status}!");
    }
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && ($_POST['_action'] ?? '') === 'update_status') {
    ...
    redirect('/fleetflow/modules/trips.php', 'Trip status updated.');
}
    ...
    <div class="table-responsive">
        <table>
            ...
            <tr>
                ...
                <td>
                    <?php if (hasRole('fleet_manager','dispatcher') && in_array($t['status'],['Draft','Dispatched'])): ?>
